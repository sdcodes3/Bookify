...
<title>Bookify - Registration</title>
<!--Bootstrap 5.2-->
...
<body class="d-flex">
    <div class="container-fluid px-0">
        <div class="d-flex bg-light py-3 justify-content-center h4 header fw-bold fixed-top">Register New Account</div>
        <div class="d-flex justify-content-center align-items-center h-100">
            <form action="formProcess.jsp" method="post" class="d-flex flex-column gap-3 border border-2 p-4 form col-xl-3 col-lg-4 col-md-5 mt-5">
            	<% if(request.getParameterMap().containsKey("error") && request.getParameter("error").equals("1")){%>
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <input type="text" id="name" name="name" placeholder="Alex Deno" required autofocus>
                </div>
                <div class="d-flex flex-column gap-2">
                    <label for="uname">Username : </label>
                    <input type="text" id="uname" name="uname" placeholder="cdcodes" required>
                </div>
                <div class="d-flex flex-column gap-2">
                ...
                <input type="submit" value="REGISTER" class="btn rounded-0">
                <input type="text" value="register" name="type" hidden="true">
                <div class="d-flex justify-content-center">
	            	Already have an account?
	            	<a href="login.jsp" class="text-danger fw-bold nav-link ms-2">Login</a>
	           	</div>
            </form>
        </div>
    </div>
