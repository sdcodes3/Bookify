...
<body class="d-flex flex-column">
	...
	<div class="container-fluid h-100 d-flex justify-content-center">
		<div class="col-12 col-md-8 col-lg-6 col-xl-4 p-0 d-flex flex-column justify-content-md-start pt-md-5 justify-content-center">
			<div class="ms-2">
				<a href="home.jsp" class="text-decoration-none fw-bold"><i class="fa-solid fa-rotate-left me-1"></i>Go back</a>
			</div>
			<div class="text-center fw-bold h2 py-5">
				Add and Publish your Insights about the book here..	
			</div>
			<form action="processInsight.jsp?addInsight=1" method="post" class="d-flex flex-column gap-3 bg-light shadow-lg p-3 rounded-2">
				<%
