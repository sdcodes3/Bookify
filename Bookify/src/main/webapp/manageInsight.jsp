	            ...
	            %>
		            <div class="card mt-2">
		                <div class="card-header d-flex justify-content-between align-items-center">
                    		...
                    		<form action="processInsight.jsp?manageInsight=1" method="POST">
                    			<input type="text" value="<% out.println(rs3.getInt("insight.id")); %>" name="insightId" hidden="true">
                    			<button class="btn btn-danger rounded-0 btn-sm">Delete</button>
                    		</form>
		                </div>
		                <div class="card-body">
